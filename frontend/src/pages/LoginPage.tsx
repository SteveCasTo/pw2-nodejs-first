  ...
  return (
    <div className="fixed inset-0 w-screen h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      >
        ...
        >
          <AnimatedTitle />
          <p className="text-white/90 mt-6 text-lg font-light tracking-wide">Sistema de Gestión de Exámenes</p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="text-xs text-white/60 space-y-1">
              ...
              <p>👤 <strong>Editor:</strong> editor@sistema.com / Editor123!@#</p>
              <p>👤 <strong>Estudiante:</strong> estudiante@sistema.com / Estudiante123!@#</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          FormifyX © 2025 - Sistema de Gestión de Exámenes
        </motion.p>
      </motion.div>
    </div>
  );
